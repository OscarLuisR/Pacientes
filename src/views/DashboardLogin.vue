            ...
            <div id="formContent">
                ...
                <form @submit.prevent="enviar">
                    <input
                        type="text"
                        id="login"
                        :class="['fadeIn second form-control', classInput($v.form.email)]"
                        name="email"
                        placeholder="Email"
                        v-model.trim="$v.form.email.$model" 
                    />

                    <div class="invalid-feedback">{{ getErrorMessage($v.form.email) }} </div>
                    
                    <input
                        type="password"
                        id="password"
                        :class="['fadeIn second form-control', classInput($v.form.password)]"
                        name="password"
                        placeholder="Password"
                        v-model.trim="$v.form.password.$model" 
                    />

                    <div class="invalid-feedback">{{ getErrorMessage($v.form.password) }} </div>
        ...
        methods: {
            async enviar() {
                try {
                    ...
                    if (this.$v.$invalid) {
                        this.error = true;
                        this.error_msg = 'Verifique los Campos Obligatorios.';
                    ...
                    const res = await authService.post(this.form);
